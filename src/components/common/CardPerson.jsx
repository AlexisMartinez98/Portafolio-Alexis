    ...
    <div className="card w-[22.5rem] h-[22.5rem] md:w-[25rem] md:h-[25rem] px-auto">
      ...
      <div className="bottom">
        <div className="content">
          <span className="name">Alexis Martinez</span>
        </div>
        <div className="bottom-bottom">
          <div className="social-links-container flex justify-center items-center gap-2">
            <a
            ...
            <a
              href="https://github.com/AlexisMartinez98"
              className="social-link"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="mailto:as.alexismartinez@gmail.com"
              className="social-link"
              rel="noopener noreferrer"
            >
              <svg
